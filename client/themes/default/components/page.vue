<template lang="pug">
  v-app(v-scroll='upBtnScroll', :dark='darkMode', :class='$vuetify.rtl ? `is-rtl` : `is-ltr`')
    ...
    v-content(ref='content', padding='0')
      template(v-if='path !== `home`')
        ...
        v-divider
      v-container.grey.pa-0(v-if='path !== `home`', fluid, :class='darkMode ? `darken-4-l3` : `lighten-4`')
      ...
      v-container.pl-5.pt-4(fluid, grid-list-xl)
        v-layout(row :justify-center='isMainPage')
          v-flex.page-col-sd(lg3, xl2, v-if='!isMainPage && $vuetify.breakpoint.lgAndUp', style='margin-top: -90px;')
...
export default {
  ...
  methods: {
    ...
    setIsMainPage () { this.isMainPage = true }
  }
}
</script>
